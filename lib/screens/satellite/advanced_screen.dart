    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          // Error
          Obx(() => satCtrl.advancedError.isNotEmpty
              ? Container(
                  ...
                  child: Text(satCtrl.advancedError.value,
                      style:
...
class _AlgorithmCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final label = SatelliteConfig.algorithmLabels[timeSeries.algorithm] ??
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              ...
              if (trend != null)
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: _trendColor(trend?.trendDirection).withValues(alpha: 0.12),
                    borderRadius: BorderRadius.circular(20),
                  ),
                  child: Row(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      Icon(_trendIcon(trend?.trendDirection),
                          size: 14,
          ...
          if (trend != null) ...[
            ...
            Text(
              'Slope: ${trend!.theilsenSlope.toStringAsFixed(4)} $unit/day  ·  R² ${trend!.rSquared.toStringAsFixed(2)}',
