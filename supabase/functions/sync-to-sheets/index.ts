...
// Column order must match the Google Sheet headers exactly (and the DB table column order).
// id and sl_no are auto-generated by Supabase, so they'll be empty when appending from the app.
const COLUMNS = [
  "id",
  "sl_no",
  "survey_date",
