...
import 'package:kalsubai_farms/screens/farmer_login_screen.dart';
...
void main() {
  ...
  for (final device in <({Size size, double textScale, String name})>[
    ...
    testWidgets('farmer login is responsive on ${device.name}', (tester) async {
